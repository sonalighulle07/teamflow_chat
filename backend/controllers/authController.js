...
// ===== Register (AUTO organization creation) =====
exports.register = async (req, res) => {
  try {
    ...
    // 2. Check if organization exists by domain
    ...
    if (orgRows.length > 0) {
      ...
      const orgName = domain.split(".")[0]; // Example: gmail → Gmail
    ...
    // 5. Create new user and assign organization_id
