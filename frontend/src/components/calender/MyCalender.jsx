...
export default function MyCalendar() {
  ...
  return (
    <div className="min-h-screen p-6 flex justify-center mt-[10px]">
      <div className=" relative mb-[20px] mt-[10px] rounded-3xl p-2 w-[950px] ">
        <Calendar
          localizer={localizer}
          events={events}
          startAccessor="start"
            ...
            <div className="space-y-4 mt-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3  text-gray-400 py-2 mt-1 mb-1 text-sm border border-gray-300 rounded-md
