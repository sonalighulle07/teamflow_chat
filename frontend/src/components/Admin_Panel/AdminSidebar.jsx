...
export default function AdminSidebar() {
  const menu = [
    { label: "Dashboard", icon: <Grid2x2 size={18} />, to: "/org-admin/dashboard" },
  ...
  return (
    <div className="w-60 min-h-screen bg-white shadow-md p-6 rounded-r-3xl space-y-8">
      ...
      {/* Logout */}
      <button className="flex items-center space-x-3 text-gray-600 hover:text-red-600 p-3 rounded-xl">
        <LogOut size={18} />
        <span>Logout</span>
      </button>
    </div>
