...
export default function CreateTeam({
  ...
  useEffect(() => {
    ...
    if (existingTeam) {
      ...
      const ids = existingTeam.members.map((m) => Number(m.user_id || m.id));
  ...
  {showModal && (
    <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/30">
     <div className="bg-white w-[500px] max-h-[80vh] overflow-y-auto rounded-2xl shadow-2xl border border-gray-200 relative">
        ...
        <div className="px-5 py-4">
          ...
          <input
            ...
            disabled={!!existingTeam}
            className="w-full mb-4 p-3 border border-gray-300 rounded-lg bg-gray-50 focus:outline-none focus:ring-2 focus:ring-purple-500"
          />
            ...
            <div className="mb-4 flex flex-wrap gap-2">
              {selectedUsers.map((id) => {
                ...
                return (
                  ...
                  >
                    {/* Avatar circle */}
                    <div className="w-6 h-6 rounded-full bg-purple-400 text-white flex items-center justify-center text-xs font-bold">
          ...
          <div className="relative mb-4">
            ...
            <input
              ...
              className="w-full p-3 pl-10 border border-gray-300 rounded-lg bg-gray-50 focus:outline-none focus:ring-2 focus:ring-purple-500"
            />
          </div>

          {/* User List */}
          <div className="max-h-60 overflow-y-auto bg-gray-50 border rounded-xl p-3 shadow-inner">
        ...
        {/* Footer */}
        <div className="mt-4 px-5 pb-4 flex justify-end gap-3">
          <button
            onClick={() => setShowModal(false)}
            className="px-4 py-2 rounded-lg border border-gray-200 text-gray-700 hover:bg-gray-200 transition"
          >
            Cancel
          </button>
